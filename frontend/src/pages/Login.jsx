...
const Login = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
      ...
      <div className='flex flex-col gap-3 border-none m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        <button type='submit' className='bg-primary-blue text-white w-full py-2 rounded-md text-base' type="submit">{state === 'Sign Up' ? 'Create Account' : 'Login'}</button>

        {
          state === 'Sign Up' ?
            <p>Already have an anccount? <span onClick={()=>setState('Login')} className='text-primary-blue underline cursor-pointer'>Login here</span></p>
