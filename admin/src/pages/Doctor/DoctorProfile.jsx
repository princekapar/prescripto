...
const DoctorProfile = () => {
  const { dtoken, setDtoken, profileData, setProfileData, getProfileData, backendUrl } =
      ...
      <div>
        <div className="flex flex-col gap-4 m-5"> 
          ...
          <div className= "flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <p className="flex items-center gap-2 text-3xl font-medium text-gray">{profileData.name}</p>
